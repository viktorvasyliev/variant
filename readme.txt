...
pg_regress.exe --psqldir="c:\Program Files (x86)\PostgreSQL\9.3\bin" --inputdir=test --load-language=plpgsql --dbname=contrib_regression _char _float _int2 _int4 _int8 _num _real _text _varchar base box float int macaddr num real text
